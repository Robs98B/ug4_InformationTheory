...
\footnotetext{We can relax this assumption by increasing the header length by 8
bits and defining some sequence of 8 bits as the ``end of header'' symbol. Using
...
member of our probability distribution: {\tt 00000000} is therefore an
unambiguous sign for the ``end of header'' symbol.}
